...
<input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $post->title }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
<textarea id="body" rows = "10" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="body" value ="{{$post->body }}" required>
...
{{$post->body }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
<input id="summary" type="text" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="summary" value = "{{$post->Summary}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            {{ __('Tags') }}
                             ...
                             <div class="col-md-6">
<input id="tags" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="tags" value="{{ $post['tags'] }}" required >
                         ...
                         <div class="form-group row">
                            ...
                            {{ __('Author') }}
                             ...
                             <div class="col-md-6">
<input id="author" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="author" value="{{ $post['author'] }}" required >
